  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='huiyuan'"  label="会员昵称" prop="huiyuannicheng">
          <el-input v-model="ruleForm.huiyuannicheng"               placeholder="会员昵称" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='huiyuan'" label="个人头像" prop="gerentouxiang">
          <file-upload
          tip="点击上传个人头像"
          action="file/upload"
          :limit="3"
          ...
          @change="huiyuangerentouxiangUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    huiyuangerentouxiangUploadChange(fileUrls) {
