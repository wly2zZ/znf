      ...
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.huiyuannicheng" class="input" type="text" placeholder="会员昵称">
			   </div>
			 </div> -->
			<el-form-item label="会员昵称" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.huiyuannicheng" autocomplete="off" placeholder="会员昵称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			...
			<el-form-item label="手机号码" class="input" v-if="tableName=='huiyuan'">
