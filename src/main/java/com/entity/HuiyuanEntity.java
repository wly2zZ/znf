...
public class HuiyuanEntity<T> implements Serializable {
	 ...
	 * 设置：会员昵称
	 */
	public void setHuiyuannicheng(String huiyuannicheng) {
		this.huiyuannicheng = huiyuannicheng;
	}
	/**
	 * 获取：会员昵称
	 */
	public String getHuiyuannicheng() {
		return huiyuannicheng;
	}
	/**
	 * 设置：性别
	 */
