<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员昵称" prop="huiyuannicheng">
          <el-input v-model="ruleForm.huiyuannicheng" 
              placeholder="会员昵称" clearable  :readonly="ro.huiyuannicheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员昵称" prop="huiyuannicheng">
              <el-input v-model="ruleForm.huiyuannicheng" 
                placeholder="会员昵称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.gerentouxiang" label="个人头像" prop="gerentouxiang">
          <file-upload
          tip="点击上传个人头像"
          action="file/upload"
          :limit="3"
          ...
          @change="gerentouxiangUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.gerentouxiang" label="个人头像" prop="gerentouxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gerentouxiang.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    gerentouxiangUploadChange(fileUrls) {
